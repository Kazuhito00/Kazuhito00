...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            Google MobileObjectLocalizerのPythonでの動作サンプル<br>ONNXに変換したモデルも同梱
        </td>
    </tr>
    <tr>
        <td width="220">
    ...
    <tr>
        ...
        <td>
            ...
            PaddleOCRv3のPythonでのONNX推論サンプル
        </td>
    </tr>
    <tr>
        <td width="220">
        ...
        <td>
            ...
            PaddleOCRv5のPythonでのONNX推論サンプル（pyclipper、shapely 未使用）
        </td>
    </tr>
    <tr>
        <th align="left" colspan="2">
    ...
    <tr>
        ...
        <td>
            ...
            Colaboratory上でLFM2-V2の推論とファインチューニングをお試しするサンプル
        </td>
    </tr>
    <tr>
        <td width="220">
        ...
        <td>
            ...
            Colaboratory上でQwen3-VLをお試しするサンプル
        </td>
    </tr>
    <tr>
        <td width="220">
        ...
        <td>
            ...
            Colaboratory上でSarashina2.2-Visionをお試しするサンプル
        </td>
    </tr>
    <tr>
        <td width="220">
        ...
        <td>
            ...
            軽量VLMのMiniCPM-V4.5のColaboratoryサンプル
        </td>
    </tr>
    <tr>
        <th align="left" colspan="2">
